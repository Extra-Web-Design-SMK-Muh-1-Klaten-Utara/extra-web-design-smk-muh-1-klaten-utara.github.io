...
const classInactive = "text-slate-300 tracking-wide";

function decorateLink(name: string): string {
    return props.active?.toLowerCase() == name ? classActive : classInactive;
}
</script>
